...
var jsonSource_gyms_ptv_sa2_join_v6_withnorms_1 = new ol.source.Vector({ attributions: ' ' });
...
var lyr_gyms_ptv_sa2_join_v6_withnorms_1 = new ol.layer.Vector({
    ...
    interactive: true,
    title: 'Gym Accessibility Index<br />\
    <img src="styles/legend/gyms_ptv_sa2_join_v6_withnorms_1_0.png" /> Very Low (0 – 0.06)<br />\
    <img src="styles/legend/gyms_ptv_sa2_join_v6_withnorms_1_1.png" /> Low (0.06 – 0.14)<br />\
    <img src="styles/legend/gyms_ptv_sa2_join_v6_withnorms_1_2.png" /> Moderate (0.14 – 0.19)<br />\
    <img src="styles/legend/gyms_ptv_sa2_join_v6_withnorms_1_3.png" /> High (0.19 – 0.32)<br />\
    <img src="styles/legend/gyms_ptv_sa2_join_v6_withnorms_1_4.png" /> Very High (0.32 – 0.71)<br />\
...
var features_SA2_GM2021_2 = format_SA2_GM2021_2.readFeatures(json_SA2_GM2021_2,
    {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7899'});
var jsonSource_SA2_GM2021_2 = new ol.source.Vector({ attributions: ' ' });
...
var lyr_SA2_GM2021_2 = new ol.layer.Vector({
    ...
    interactive: true,
    title: '<img src="styles/legend/SA2_GM2021_2.png" /> SA2 Boundaries'
});
...
var features_ptv_stops_clipped_3 = format_ptv_stops_clipped_3.readFeatures(json_ptv_stops_clipped_3,
    {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7899'});
var jsonSource_ptv_stops_clipped_3 = new ol.source.Vector({ attributions: ' ' });
...
var lyr_ptv_stops_clipped_3 = new ol.layer.Vector({
    ...
    interactive: true,
    title: '<img src="styles/legend/ptv_stops_clipped_3.png" /> Public Transport Stops'
});
...
var features_gym_points_v2_clipped_4 = format_gym_points_v2_clipped_4.readFeatures(json_gym_points_v2_clipped_4,
    {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7899'});
var jsonSource_gym_points_v2_clipped_4 = new ol.source.Vector({ attributions: ' ' });
...
var lyr_gym_points_v2_clipped_4 = new ol.layer.Vector({
    ...
    interactive: true,
    title: '<img src="styles/legend/gym_points_v2_clipped_4.png" /> Gym Locations'
});

lyr_OSMStandard_0.setVisible(true);
lyr_gyms_ptv_sa2_join_v6_withnorms_1.setVisible(true);
lyr_SA2_GM2021_2.setVisible(true);
lyr_ptv_stops_clipped_3.setVisible(true);
lyr_gym_points_v2_clipped_4.setVisible(true);
...
lyr_gyms_ptv_sa2_join_v6_withnorms_1.set('fieldLabels', {'fid': 'no label', 'SA2_CODE21': 'no label', 'SA2_NAME21': 'no label', 'AREASQKM21': 'no label', 'gym_count': 'no label', 'ptv_stop_count': 'no label', 'gyms_per_10k_pop': 'no label', 'ptv_per_sqkm': 'no label', 'norm_gyms': 'no label', 'norm_ptv': 'no label', 'seifa_score_num': 'no label', 'norm_seifa': 'no label', 'weighted_GAI': 'no label', 'seifa_SA2_NAME21': 'no label', 'seifa_Population': 'no label', 'seifa_IRSD_Score': 'no label', });
